...
const calendarClassNames: NonNullable<DayPickerProps['classNames']> = {
  ...
  button_previous: 'absolute left-1 inline-flex size-7 items-center justify-center rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground',
  button_next: 'absolute right-1 inline-flex size-7 items-center justify-center rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground',
