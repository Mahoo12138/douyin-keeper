...
func Load() *Config {
	return &Config{
		...
		PlaywrightSidecarCommand: env("PLAYWRIGHT_SIDECAR_COMMAND", "node"),
		PlaywrightSidecarScript:  env("PLAYWRIGHT_SIDECAR_SCRIPT", "sidecars/playwright-node/sidecar.mjs"),
