...
function GuestTasks() { return <View className="mini-page task-page"><View className="task-empty"><MiniRemoteImage className="task-empty-image" name="tasks/task-checklist.png" mode="aspectFit" /><Text className="task-empty-title">请先登录</Text><Text className="muted">登录后才能查看和管理任务。</Text><Button className="task-primary-button" onClick={() => Taro.switchTab({ url: '/pages/login/index' })}>去登录 / 绑定</Button></View></View> }
