...
import { redeemErrorMessage } from '@/features/entitlement/entitlement-error-utils'
...
const profileAvatar = miniAssetUrl('me/avatar-profile.png')
const mascotSprout = miniAssetUrl('me/mascot-sprout.png')
const authGuardian = miniAssetUrl('me/auth-guardian.png')
...
export default function Me() {
  ...
  async function redeem() {
    ...
    try {
      ...
      setMessage(cause instanceof MiniApiError ? redeemErrorMessage(cause.code, cause.message) : '卡密兑换失败，请稍后重试。')
    } finally {
      setBusy('')
    }
  }
